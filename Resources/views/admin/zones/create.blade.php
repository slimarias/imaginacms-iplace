...
@section('content-header')
    <h1>
        {{ trans('iplaces::zones.title.create zone') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i
                        class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.iplaces.zone.index') }}">{{ trans('iplaces::zones.title.zones') }}</a></li>
        <li class="active">{{ trans('iplaces::zones.title.create zone') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.iplaces.zone.store'], 'method' => 'post']) !!}
    <div class="row">
                        ...
                        <div class="box-body ">
                            <div class="box-footer">
                                ...
                                <a class="btn btn-danger pull-right btn-flat"
                                   href="{{ route('admin.iplaces.zone.index')}}"><i
