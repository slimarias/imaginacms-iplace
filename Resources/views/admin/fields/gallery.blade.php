...
<div class="modal fade" id="modalGallery" aria-labelledby="modalGalleryLabel" tabindex="-1" role="dialog">
                    ...
                    <div style="padding:0 15px 20px">
                        <form id="{{$field['name']}}-dropzone" class="dropzone" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                ...
                                <div class="dz-message"><span class="h4">{!!trans('iplaces::places.form.label_click')!!}</span>
                                </div>
